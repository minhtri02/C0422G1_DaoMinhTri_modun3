...
<dev class="container-fluid">
    <nav class="row">
        ...
        <dev class="col-lg-8">
            ...
            <button class="btn btn-outline-primary" type="button" onclick="location.href='/Product?action=add';">Thêm sản phẩm</button>
            <br><br>
            ...
            <table border="1" class="table " style="text-align: center">
                ...
                <c:forEach var="product" items="${productList}" varStatus="status">
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-outline-primary" type="button" onclick="location.href='/Product?action=edit&id=${product.id}';">edit
                            </button>
                        </td>
                        <td>
