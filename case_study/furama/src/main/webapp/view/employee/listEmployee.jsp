    ...
    <nav class="col-lg-12 d-flex justify-content-center">
        <form class="justify-content-center d-flex" action=""
            ...
            <fieldset>
                ...
                <button type="button" class="btn-primary button" data-bs-toggle="modal"
                        data-bs-target="#modalAddEmployee">Add Employee</button>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn " type="button"
                                    onclick="location.href='/customer?action=showEditCustomer'">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                     class="bi bi-pencil-fill" viewBox="0 0 16 16">
                                    <path d="M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708l-3-3zm.646 6.061L9.793 2.5 3.293 9H3.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.207l6.5-6.5zm-7.468 7.468A.5.5 0 0 1 6 13.5V13h-.5a.5.5 0 0 1-.5-.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.5-.5V10h-.5a.499.499 0 0 1-.175-.032l-.179.178a.5.5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11l.178-.178z"/>
                                </svg>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="justify-content-center d-flex" action="">
                    <fieldset>
                        <table class="table justify-content-center d-flex" style="border: 1px solid #A9A9A9; border-radius: 20px; width: 100%">
                            <tr>
                                <th scope="col">Tên Nhân viên:</th>
                            ...
                            <tr>
                                <th scope="col">Ngày sinh</th>
                                <th scope="col"><input type="date"></th>
                            </tr>
                            <tr>
                                <th scope="col">Số CMND</th>
                                <th scope="col"><input type="text"></th>
